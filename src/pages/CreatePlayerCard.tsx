...
export default function CreatePlayerCard() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col md:flex-row">
      ...
      {/* Control panel (Left) */}
      <div className="w-full md:w-[45%] bg-slate-900 border-r border-slate-800 p-6 md:p-8 flex flex-col gap-6 overflow-y-auto max-h-screen">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-300">Athlete Name</label>
            <input 
              type="text" 
              maxLength={25}
              value={playerName}
              onChange={(e) => setPlayerName(e.target.value)}
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-sm focus:border-red-500 outline-none transition-all"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-300">Sport / Position</label>
              <input 
                type="text" 
                maxLength={20}
                value={sportName}
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-300">Graduating Class</label>
              <input 
                type="text" 
                maxLength={18}
                value={playerClass}
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-slate-300">Team / Academy Name</label>
            <input 
              type="text" 
              maxLength={30}
              value={teamName}
        ...
        <div className="space-y-4">
          <h2 className="text-xs font-black text-slate-400 uppercase tracking-widest border-b border-slate-800 pb-2">Export Format</h2>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-slate-100 text-black rounded-2xl py-4 flex items-center justify-center gap-2 font-black text-sm uppercase tracking-wider transition-colors cursor-pointer shadow-lg hover:shadow-xl disabled:opacity-50"
          >
            <Download className="w-5 h-5" />
            <span>{isDownloading ? 'Rerendering Premium Card...' : 'Save & Download Card'}</span>
          </button>
        </div>
      </div>
